...
per-episode metrics: this plots the mean_*.csv row, i.e. the across-seed MEAN at the
...
describing either one. Check the per-seed spread for the combo before
reading a radar axis as "the" behaviour.
"""
