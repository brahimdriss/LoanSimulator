...
def run_job(
    ...
    test_cmd = [
        ...
        results_dir,
        "--weights",
        os.path.join(results_dir, f"{reward}_{constraint}_seed{seed}.pt"),
    ]
...
Examples:
  ...
  nohup uv run python schedule_jobs.py --episodes 200 > scheduler_output.log 2>&1 &
    ...
    log_message(global_log, "INFO", "Sequential Static Job Scheduler Started")
    log_message(
        global_log,
        "INFO",
