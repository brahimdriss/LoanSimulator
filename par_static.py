...
def pepg_train_worker(config):
    ...
    try:
        ...
        save_episode_metrics(
            ...
            f"pg_train_{config['reward_function']}",
            config["constraint_type"],
            config["seed"],
...
def run_pepg_v2_experiment(
    ...
    episode_metrics_dir: str = "./episode_metrics_pg_train",
    ...
    if save_episode_metrics_flag:
        ...
        save_episode_metrics(
            agent.episode_metrics,
            f"pg_train_v2_{reward_function}",
            constraint_type,
            seed,
    ...
    if plot_episode_metrics_flag:
        os.makedirs(episode_metrics_dir, exist_ok=True)
        episode_plot_path = f"{episode_metrics_dir}/pg_train_{reward_function}_{constraint_type}_seed{seed}_metrics.png"
        plot_episode_metrics(
            agent.episode_metrics,
            f"PePG_v2 {reward_function}",
            constraint_type,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--episode-metrics-dir", type=str, default="./episode_metrics_pg_train"
    )
    parser.add_argument(
