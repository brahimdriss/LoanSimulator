...
=======
    "constraints": ["approval_rate","wealth", "both"],
    "seeds": range(25, 30),
>>>>>>> 10bfdd49de93c9984cd4e9b7c93a3e31c4f75b75
}
# "constraints": ["approval_rate", "wealth", "both"],
...
def run_job(
    ...
    test_cmd = [
        ...
        results_dir,
        "--weights",
        os.path.join(results_dir, f"pepg_{reward}_{constraint}_seed{seed}.pt"),
    ]
...
Examples:
  ...
  nohup uv run python schedule_jobs.py --episodes 200 > scheduler_output.log 2>&1 &
    ...
    parser.add_argument(
        "--results-dir",
        type=str,
        default="./pepg_sequential_results",
    ...
    parser.add_argument(
        "--logs-dir",
        type=str,
        default="./job_logs_pepg",
        help="Directory for job logs (default: ./job_logs_pepg)",
    )
    parser.add_argument(
        "--progress-file",
        type=str,
        default="./job_progress_pepg.json",
    ...
    log_message(global_log, "INFO", "Sequential PePG Job Scheduler Started")
    log_message(
        global_log,
        "INFO",
