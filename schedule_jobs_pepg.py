...
JOB_MATRIX = {
    ...
    # Options: ["approval_rate"], ["wealth"], ["both"], or any combination
    "constraints": ["wealth"],
    "seeds": range(2, 6),
}
...
def run_job(
    ...
    """Run a single PePG training + testing job. Returns True on success."""
    ...
    test_cmd = [
        ...
        "--weights", os.path.join(
            results_dir, f"pepg_{reward}_{constraint}_seed{seed}.pt"
        ),
    ]
...
def main():
    ...
    parser.add_argument(
        "--results-dir", type=str, default="./pepg_sequential_results",
        help="Directory for training results (default: ./pepg_sequential_results)",
    )
    parser.add_argument(
        "--logs-dir", type=str, default="./job_logs_pepg",
        help="Directory for job logs (default: ./job_logs_pepg)",
    )
    parser.add_argument(
        "--progress-file", type=str, default="./job_progress_pepg.json",
        help="Progress tracking file (default: ./job_progress_pepg.json)",
    )
    parser.add_argument(
    ...
    run_scheduler(
        ...
        scheduler_label="Sequential PePG Job Scheduler",
